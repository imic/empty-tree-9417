...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/empty-tree-9417
```

A live public deployment of this template is available at [https://empty-tree-9417.templates.workers.dev](https://empty-tree-9417.templates.workers.dev)
